...
for i=1:N
    if mod(k_c,param_MPC_low.M) == 0
        tic
        u_mpc_rm = MPC_solve_RM(x,u_mpc_rm_0,u_mpc_rm_prev,u_mpc_sr,k,param_sim,param_MPC_low,param_MPC_high,scenario);
    ...
    if mod(k_c,param_MPC_high.M) == 0
        tic
        u_mpc_sr = MPC_solve_SR(x,u_mpc_sr_0,u_mpc_sr_prev,u_mpc_rm,k,param_sim,param_MPC_low,param_MPC_high,scenario);
        total_comp_time = total_comp_time + toc;
