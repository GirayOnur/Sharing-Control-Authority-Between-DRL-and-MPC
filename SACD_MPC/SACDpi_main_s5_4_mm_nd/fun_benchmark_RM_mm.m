...
% MPC prediction model under model mismatch. Same equations as
% fun_benchmark_RM, but called with the perturbed parameters
% (param_get_mm) and the estimated demands (demandoNmm).
