function [obj,con,info] = bayes_cost_PI_ALINEA_MPC_nd(pi_alinea_params)
...
for i=1:N
    ...
    if mod(k_c,param_MPC_high.M) == 0
        tic
        u_mpc_sr = MPC_solve_SR_w_PI_ALINEA_nd(x,u_mpc_sr_0,u_mpc_sr_prev,u_PI_ALINEA,k,param_sim,param_MPC_low,param_MPC_high,scenario,pi_alinea_params,x_prev,u_PI_ALINEA_prev,Demands);
        total_comp_time = total_comp_time + toc;
