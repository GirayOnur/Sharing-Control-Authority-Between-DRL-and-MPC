...
agent_mat = load("agent_2025-08-21 04_30_53.mat");
agent = agent_mat.agent;

% agent_mat = load("Agent2000.mat");
...
for i=1:N
    ...
    if mod(k_c,param_MPC_high.M) == 0
        tic
        u_mpc_sr = MPC_solve_SR_w_RL_h_mm(x,u_mpc_sr_0,u_mpc_sr_prev,u_rl,k,param_mm,param_MPC_low,param_MPC_high,scenario,agent);
        total_comp_time = total_comp_time + toc;
