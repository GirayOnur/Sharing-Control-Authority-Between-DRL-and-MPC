function x_n = fun_benchmark_RM_mm(x,u,k,param,scenario)
% Same step function as fun_benchmark_RM but for the controller only. It is
% called with the wrong parameters (param_get_mm) and the wrong demand
% (demandoNmm), which is the mismatch the _mm experiments are about.
...
%%%
[d_o_1_c1, d_o_1_c2] = demando1mm(k-1,scenario);
[d_o_1_c1_n, d_o_1_c2_n] = demando1mm(k,scenario);
...
%
[d_o_2_c1, d_o_2_c2] = demando2mm(k-1,scenario);
[d_o_2_c1_n, d_o_2_c2_n] = demando2mm(k,scenario);
...
%
[d_o_3_c1, d_o_3_c2] = demando3mm(k-1,scenario);
[d_o_3_c1_n, d_o_3_c2_n] = demando3mm(k,scenario);
