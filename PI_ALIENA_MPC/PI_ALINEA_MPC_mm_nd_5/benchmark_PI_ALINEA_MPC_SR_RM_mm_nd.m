...
load("Bayes_opt_PI_ALINEA_mm_nd_result_2025-09-11 01_17_49.mat")
...
for i=1:N
    ...
    if mod(k_c,param_MPC_high.M) == 0
        tic
        u_mpc_sr = MPC_solve_SR_w_PI_ALINEA_h_mm_nd(x,u_mpc_sr_0,u_mpc_sr_prev,u_PI_ALINEA,k,param_mm,param_MPC_low,param_MPC_high,scenario,pi_alinea_params,x_prev,u_PI_ALINEA_prev);
        total_comp_time = total_comp_time + toc;
...
mpc_result_doc_name = 'PI_ALINEA_MPC_SR_RM_mm_nd_result_' + string(datetime('now'), 'yyyy-MM-dd hh_mm_ss') + '.mat';
