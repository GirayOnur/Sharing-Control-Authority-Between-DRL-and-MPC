function u_mpc = MPC_solve_SR_w_PI_ALINEA_nd(x0,u0,u_mpc_prev,u_rm,k,param,MPC_param_low,MPC_param_high,scenario,pi_alinea_params,x_prev,u_PI_ALINEA,demands)
