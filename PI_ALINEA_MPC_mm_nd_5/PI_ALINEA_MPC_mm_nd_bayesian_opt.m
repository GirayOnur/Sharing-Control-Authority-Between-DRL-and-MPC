...
objFun = @(params) bayes_cost_PI_ALINEA_MPC_mm_nd(params);

optimResults = bayesopt(objFun,optimVars,'MaxObjectiveEvaluations', inf, 'MaxTime', 14400 , UseParallel=true, PlotFcn=[], Verbose=0);

opt_result_doc_name = 'Bayes_opt_PI_ALINEA_mm_nd_result_' + string(datetime('now'), 'yyyy-MM-dd hh_mm_ss') + '.mat';
...
% 
% 
% run benchmark_PI_ALINEA_MPC_SR_RM_mm_nd.m
